...
const EditPerfume: FC = (): ReactElement => {
    ...
    const onFormSubmit = (data: EditPerfumeData): void => {
        ...
        bodyFormData.append(
            "perfume",
            new Blob(
                [JSON.stringify({ ...data, id: perfumeData?.id })],
                    ...
                    <Col span={12}>
                        ...
                        <div className={"edit-perfume-image-wrapper"}>
                            ...
                            <img
                                ...
                                src={
                                    perfumeData.filename?.startsWith("http")
                                    || perfumeData.filename?.startsWith("/img/")
                                        ? perfumeData.filename
                                        : `http://localhost:8080/uploads/${perfumeData.filename}`
                                }
