...
public class PerfumeServiceImplTest {
    ...
    public void filter() {
        ...
        when(perfumeRepository.findPerfumesByFilterParams(perfumers, genders, 1, 1000, pageable)).thenReturn(perfumeList);
        ...
        verify(perfumeRepository, times(1)).findPerfumesByFilterParams(perfumers, genders, 1, 1000, pageable);
    }
